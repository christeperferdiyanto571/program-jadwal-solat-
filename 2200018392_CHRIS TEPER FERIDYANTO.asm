...
daftar db 13,10,' __________________________________'
       db 13,10,'                                   '
       db 13,10,' +***DAFTAR JADWAL SHOLAT WAJIB***+'
...
;-----------------------------------------------------------------------------------------
teks1  db 13,10,' '
       db 13,10,'Anda memilih No. 1 adalah Sholat SUBUH'
       db 13,10,'Waktu Sholat SUBUH : 03:48 WIB'
       db 13,10,'Terima Kasih Semoga Menjalankan Ibadah Dengan Khusyuk $'
teks2  db 13,10,' '
       db 13,10,'Anda memilih No. 2 adalah Sholat DHUHUR'
       db 13,10,'Waktu Sholat DHUHUR : 11.29 WIB'
       db 13,10,'Terima Kasih Semoga Menjalankan Ibadah Dengan Khusyuk $'
teks3  db 13,10,' '
       db 13,10,'Anda memilih No 3 adalah Sholat ASYAR'
